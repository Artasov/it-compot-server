...
class AmoCallTranscribeSerializer(AsyncSerializer):
    ...
    responsible = serializers.CharField(max_length=500, required=False, allow_blank=True)
    duration = serializers.CharField(max_length=30, required=False)
    status = serializers.CharField(max_length=150, required=False, allow_blank=True)
